...
def main():
    ...
    print(f"Ratings with comments: {with_comment} ({with_comment / total_ratings:.2%})")
    print(f"Ratings without comments: {without_comment} ({without_comment / total_ratings:.2%})")
